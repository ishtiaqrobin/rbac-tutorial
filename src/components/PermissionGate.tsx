 ...
 *
 * The permissions checked here come from the JWT payload.  The backend
 * independently verifies the same permissions on every API call — so
 * even if a user tampers with the JWT, the server-side RBAC middleware
 * will still block them.
 */
